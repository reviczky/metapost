...
\begin{figure}[hptb]
	\begin{center}
    \textattachfile[color={0 0 0},mimetype={text/plain}]{parabola.mp}{\includegraphics{parabola.mps}}
  \end{center}
...
\begin{figure}[hptb]
	\begin{center}
    \hfill%
    \textattachfile[color={0 0 0},mimetype={text/plain}]{label.mp}{\includegraphics{label-1.mps}}%
    \hfill%
    \textattachfile[color={0 0 0},mimetype={text/plain}]{label.mp}{\includegraphics{label-2.mps}}%
    \hfill\mbox{}
  \end{center}
