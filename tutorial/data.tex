...
There are nine data types in \MP{}: \textit{numeric}, \textit{pair}, \textit{path}, \textit{transform}, \textit{color}, \textit{string}, \textit{boolean}, \textit{picture}, and \textit{pen}.  These data types allow users to store fragments of the graphics for later use.  We will briefly discuss each of these data types and elaborate on how they are used in a typical \MP{} program.
\renewcommand{\labelitemi}{\textattachfile[color={0 0 0},mimetype={text/plain}]{diamond.mp}{\includegraphics{diamond}}}
%\renewcommand{\labelitemi}{\includegraphics{diamond}}
\begin{itemize}
