...
\begin{figure}[hptb]
	\begin{center}
    \textattachfile[color={0 0 0},mimetype={text/plain}]{fill.mp}{\includegraphics{fill.mps}}
  \end{center}
...
\begin{figure}[hptb]
	\begin{center}
    \textattachfile[color={0 0 0},mimetype={text/plain}]{annulus.mp}{\includegraphics{annulus-1.mps}}
  \end{center}
...
\begin{figure}[hptb]
	\begin{center}
    \textattachfile[color={0 0 0},mimetype={text/plain}]{annulus.mp}{\includegraphics{annulus-2.mps}}
  \end{center}
...
\begin{figure}[ht]
	\begin{center}
    \textattachfile[color={0 0 0},mimetype={text/plain}]{annulus.mp}{\includegraphics{annulus-3.mps}}
  \end{center}
