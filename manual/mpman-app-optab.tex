...
postcontrol of\index{postcontrol?\texttt{postcontrol}}&  numeric&  path&  pair&  \pageref{Dpostcontrol}&  First B\'ezier control point on path segment starting at the given time\\\hline
precontrol of\index{precontrol?\texttt{precontrol}}&  numeric&  path&  pair&  \pageref{Dprecontrol}&  Last B\'ezier control point on path segment ending at the given time\\\hline
