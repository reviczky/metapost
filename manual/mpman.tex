...
The MetaPost distribution contains a script \texttt{mproof.tex} that
helps with the latter approach.  The script is in (plain) \TeX, no
MetaPost at all.  To write a proof sheet for MetaPost output, call
\ttindex{mproof.tex} as
$$
\begin{verbatim}[commandchars=\\\{\}]
