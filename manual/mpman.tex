...
freely available program \ttindex{dvips}.\footnote{The C source for
  ...
  are available from other sources.}  For the PDF flavour of \TeX\ and
\LaTeX\ the situation is a little bit different.  The next paragraphs
give brief information on some popular \TeX\ formats and output drivers.
