...
The MetaPost distribution contains two (plain) \TeX\ scripts that help
...
The \texttt{mpsproof.tex} script is similar to \texttt{mproof.tex}, but
more powerful.  While the latter script only runs with \TeX\ and
...
Other alternatives for previewing MetaPost figures are the mptopdf
bundle\index{mptopdf} or the Perl script \ttindex{mpstoeps.pl}.  But
those are not part of the MetaPost distribution.  There is also an
online viewer for MetaPost code at \url{http://tlhiv.org/mppreview/}.
