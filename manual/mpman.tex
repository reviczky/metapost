...
can be used to derive custom paths from.  The predefined path
\texttt{fullcircle}\index{fullcircle?\texttt{fullcircle}}\label{Dfcirc}
is a very good approximation of a closed circle of unit diameter
centered on the origin.  There are also
...
quadrant and the latter covering just the first quadrant.  Rectangularly
shaped paths can be derived from
\texttt{unitsquare}\index{unitsquare?\texttt{unitsquare}}\label{Dunitsqr},
which is defined as a closed square of unit side length whose lower left
