...
applications.  Appendix~\ref{mpimport} deals with the import of MetaPost
...
For a way to request the control points of a path segment, given by the
user or calculated by MetaPost, see section~\ref{Dprepostctrl}.
