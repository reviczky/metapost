...
that approximates a circle of unit diameter centered on the origin.
There are also predefined paths
...
quadrant and the latter being the part covering just the first quadrant.
Path~{\tt ab} is then initialized using a predefined macro {\tt
  buildcycle} that will be discussed shortly.
