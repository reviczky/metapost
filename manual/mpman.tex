...
corresponding output file.  See section~\ref{Doutputtemplate} for more
...
section~\ref{Doutputtemplate}). Hence, no \verb+\DeclareGraphicsRule+
...
\ttt{outputformat}\label{Doutputformat} to \ttt{svg}:
