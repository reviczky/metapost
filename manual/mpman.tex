...
\verb|\encapsulate|\index{mpsproof.tex?\texttt{mpsproof.tex}!encapsulate?\texttt{\textbackslash
    encapsulate}} option can be used to generate an output file that has
exactly the same page size as a figure's bounding box.  With this option
only one figure can be processed, e.g.,
$$
\begin{verbatim}
