...
\emph{As of October 2010, \texttt{dvips}\index{dvips?\texttt{dvips}}
  v5.99 doesn't handle MetaPost output gracefully, if prologues is set
  to a value larger than~0.  It is therefore \textsc{mandatory} to reset
  prologues to~0 before including MetaPost graphics into \TeX\ documents
  that are post-processed by \texttt{dvips}, currently.}
