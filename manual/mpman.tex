...
the mathematical model that is used to describe paths in MetaPost (see
below), all these are not exactly circular paths, but very good
approximations.
...
corner is located at the origin (figure~\ref{fig3a}).
