...
would want to use \texttt{.svg} instead.  A more general approach is to
evaluate variable \verb|outputformat| within \verb|outputtemplate| via
the \verb|%{...}| escape sequence:
...
\end{verbatim}
$$
Now, one can switch between PostScript and SVG output by uncommenting
the line with the proper assignment to \verb|outputformat| and have the
correct file extension added automatically.
