...
rules laid out above.  The filling is necessary for the picture to
...
saves the contours of the lower case letter~``g'' in the Computer Modern
...
\verb|fontmapfile| (see section~\ref{Sfontmapfile}).
