...
\tt     hppp&           \pageref{Dhppp}&
        The number of horizontal pixels per point for bitmap output\\\hline
...
\tt     vppp&           \pageref{Dvppp}&
        The number of vertical pixels per point for bitmap output\\\hline
...
$\tt \qquad \;|\; outputformat \;|\; outputformatoptions \;|\; outputtemplate \;|\; pausing \;|\; prologues \;|\; showstopping$\\
