...
\cfunction{int }{mp_png_ship_out}{(mp_edge_object*hh,int prologues)}
...
Note: the \type{prologues} argument is currently unused, but it may be used
in the future to support \MNG\ output.
